...
struct Item {
    ...
    init(id: String, itemName: String, itemDescription: String, imageName: String, images: NSDictionary, purchaseAmount: String, purchaseDate: String, roomId: String, uid: String) {
